...
[**功能特性**](#-功能特性) · [**交流群**](#-交流群) · [**快速開始**](#-快速開始) · [**推送效果**](#-推送效果) · [**完整指南**](./full-guide.md) · [**常見問題**](./FAQ.md) · [**更新日誌**](./CHANGELOG.md)
...
歡迎加入社群交流專案使用經驗與技術話題，群內僅供**專案交流**與**技術分享**，**禁止廣告與薦股**。

- **Telegram**：<https://t.me/+1yyZAGuiiw8xYmQ9>
- **微信群**：現有群都已超過 200 人，可加入小助手 ``_oox_xoo`` 申請進群
- **小紅書**：歡迎關注後續進展 <https://www.xiaohongshu.com/user/profile/61594417000000000201fa68>
